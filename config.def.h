...
/* Theme colors - semantic names for easy theme switching */
static const char normal_bg[]     = "#1a1b26";  /* Normal window background */
static const char normal_fg[]     = "#c0caf5";  /* Normal window foreground */
static const char normal_border[] = "#414868";  /* Normal window border */
static const char select_bg[]     = "#24283b";  /* Selected window background */
static const char select_fg[]     = "#ffffff";  /* Selected window foreground */
static const char select_border[] = "#7aa2f7";  /* Selected window border */

/* Legacy color definitions - keep for compatibility with other tools */
...
// };
 ...
 static const char *colors[][3] = {
    ...
    [SchemeSel]  = { select_fg, select_bg, select_border },
};
...
static const char *dmenucmd[] = {
    "dmenu_run", "-m",  dmenumon,  "-fn", dmenufont, "-nb", normal_bg, "-nf",
...
static const char *surfer[] = {"~/.local/bin/surfer", "-m",  dmenumon,  "-fn", dmenufont, "-nb", normal_bg, "-nf", normal_fg,   "-sb", select_bg, "-sf", select_fg, NULL};
...
static Key keys[] = {
    ...
    {MODKEY | ShiftMask, XK_t, spawn, {.v = themeswitch}},
