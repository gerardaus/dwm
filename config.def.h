...
static const char *fonts[] = { "mono:pixelsize=14:antialias=true:autohint=true" };
...
/* tagging */
static const char *tags[] = { "term", "browser", "chat", "misc", "system" };
...
static const char *chromiumcmd[] = {"/usr/bin/brave", NULL };
